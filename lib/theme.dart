...
/// Game-specific UI colors (kept here to avoid hardcoding colors in widgets).
class AppGameColors {
  /// Yellow background for the question card.
  static const Color questionCardBgLight = Color(0xFFFFF3B0);
  static const Color questionCardBgDark = Color(0xFF5A4B1A);

  /// Background colors for each player's answer pad (the whole player tile).
  /// Order: Player 1..4
  static const List<Color> playerPadBgLight = [
    Color(0xFFEEF1F4), // Player 1 - light gray
    Color(0xFFE4F1FF), // Player 2 - light blue
    Color(0xFFFFE6EF), // Player 3 - light pink
    Color(0xFFFFE8D1), // Player 4 - light orange
  ];
  ...
  /// Distinct answer-button colors per player (A/B/C/D pad buttons).
  static const List<Color> playerAnswerBgLight = [
    Color(0xFF4A86C5), // Player 1 - deeper blue
    Color(0xFF2E8B57), // Player 2 - deeper green
    Color(0xFFCC6B1D), // Player 3 - deeper orange
    Color(0xFF6E4DBA), // Player 4 - deeper purple
  ];
  ...
  /// Answer reveal colors on the question card (correct answer highlight).
  ...
  /// Balance level colors (used for meter + contextual UI like deduct sheet)
  ...
  /// Score tile (points) in the top columns.
  static const Color scorePointsBg = Color(0xFF0D2B45); // dark blue
